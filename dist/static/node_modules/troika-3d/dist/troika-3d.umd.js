(function(global, factory) {
...
}(this, (function(exports, three, troikaCore, troikaThreeUtils, React, T) {
    'use strict';
    ...
    Object.defineProperty(Object3DFacade.prototype, 'isObject3DFacade', {
        value: true
    });
    ...
    var attrRefReplacer = function(name, index, str) {
        return precededByUniformRE.test(str.substr(0, index)) ? name : ("troika_" + name);
    };
    var varyingRefReplacer = function(name, index, str) {
        return precededByUniformRE.test(str.substr(0, index)) ? name : ("troika_vary_" + name);
    };
    ...
    var InstancingManager = /*@__PURE__*/ (function(Group3DFacade) {
        ...
        InstancingManager.prototype._teardownBatchObjects = function _teardownBatchObjects(renderer, scene, camera) {
            ...
            scene.children = scene.children.filter(function(obj) {
                return obj.$troikaInstancingManager !== this$1;
            });
        };
    ...
    BatchGeometryPool.prototype.borrow = function borrow(key, baseGeometry, instanceUniformSizes) {
        ...
        var pool = poolsByKey[key] || (poolsByKey[key] = {
            geometries: [],
            firstFree: 0
        });
        ...
        if (!batchGeometry) {
            ...
            var instanceAttrs = batchGeometry._instanceAttrs = {
                matrix: [],
                uniforms: Object.create(null)
            }; //separate collections for quicker lookup
    ...
    BoundingSphereOctree.prototype._putSphere = function _putSphere(key, sphere) {
        ...
        // Second sphere being added:
            ...
            // that contains both sphere centerpoints. (Cube rounded to whole ints to avoid floating point issues)
                ...
                oldRoot.forEachLeafSphere(function(_sphere, _key) {
                    return this$1._insertIntoOctant(_key, _sphere, newRoot$1);
                });
        ...
        // The parent octant is a branch:
            ...
            if (!subOctant) {
                ...
                for (var oct$1 = newLeaf.parent; oct$1; oct$1 = oct$1.parent) {
                    if (radius > oct$1.maxRadius) {
                        oct$1.maxRadius = radius;
                    }
                    oct$1.leafCount++;
                }
    ...
    var geometries = Object.create(null, [
        ...
        descr[name] = {
            get: troikaCore.utils.memoize(function() {
                return new three.CircleBufferGeometry(1, segments).rotateX(-Math.PI / 2);
            })
        };
        return descr
    }, {}));
    ...
    var geometries$1 = Object.create(null, [
        ...
        descr[name] = {
            get: troikaCore.utils.memoize(function() {
                return new three.SphereBufferGeometry(1, wSegs, hSegs);
            })
        };
        return descr
    }, {}));
