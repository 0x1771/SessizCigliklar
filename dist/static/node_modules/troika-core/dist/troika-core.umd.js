(function(global, factory) {
...
}(this, (function(exports, troikaAnimation, React, T) {
    'use strict';
    ...
    Facade.prototype.addEventListener = function addEventListener(type, handler) {
        this.notifyWorld('addEventListener', {
            type: type,
            handler: handler
        });
    };
    ...
    Facade.prototype.removeEventListener = function removeEventListener(type, handler) {
        this.notifyWorld('removeEventListener', {
            type: type,
            handler: handler
        });
    };
    ...
    var extendAsAnimatable = createClassExtender('animatable', function(BaseFacadeClass) {
        ...
        function defineTransitionPropInterceptor(propName, currentInstance) {
            if (!AnimatableFacade.prototype.hasOwnProperty(propName)) {
                ...
                Object.defineProperty(AnimatableFacade.prototype, actuallySetKey, {
                    value: actuallySet
                });
    ...
    var extendAsPointerStatesAware = createClassExtender('pointerStates', function(BaseFacadeClass) {
        ...
        Object.defineProperty(PointerStatesAware.prototype, 'isPointerStateAware', {
            value: true
        });
    ...
    Object.defineProperty(PointerEventTarget.prototype, 'isPointerEventTarget', {
        value: true
    });
    ...
    var WorldBaseFacade = /*@__PURE__*/ (function(ParentFacade) {
            ...
            if (eventRegistry.hasAnyListenersOfType('dragstart') || pointerActionEventTypes.some(eventRegistry.hasAnyListenersOfType)) {
                ...
                if (facade) {
                    ...
                    if (e.type === 'mousedown' || e.type === 'touchstart') {
                        ...
                        if (dragger) {
                            var dragStartEvent = new SyntheticEvent(e, 'dragstart', dragger, null, {
                                intersection: hoverInfo
                            });
                            eventState.dragInfo = {
        ...
        WorldBaseFacade.prototype._findHoverTarget = function _findHoverTarget(e) {
            ...
            var allHits = this.getFacadesAtEvent(e, function(facade) {
                return facade.isPointerEventTarget && facade.interceptsPointerEvents(this$1.eventRegistry);
            });
            if (allHits) {
    ...
    Object.defineProperty(WorldBaseFacade.prototype, 'isWorld', {
        value: true
    });
                ...
                React.createElement(
                    ...
                    items.map(function(ref) {
                        ...
                        return React.createElement(
                            ...
                            React.createElement(HtmlOverlayContent, {
                                html: html
                            })
                        )
                    })
        ...
        Stats.prototype.render = function render() {
            ...
            return (
                React.createElement(
                    ...
                    Object.keys(stats).sort().map(function(key) {
    ...
    var CanvasBase = /*@__PURE__*/ (function(superclass) {
        ...
        CanvasBase.prototype.updateWorld = function updateWorld() {
            ...
            if (world) {
                ...
                if (useStats) {
                    this.updateStats({
                        'Last World Update (ms)': Date.now() - start
                    });
                }
            }
        };
            ...
            return (
                React.createElement(
                    ...
                    React.createElement(HtmlOverlay, {
                        ref: this._bindHtmlOverlayRef
                    }),
                    props.stats ? React.createElement(Stats, {
                        ref: this._bindStatsRef
                    }) : null
                )
            )
        };
