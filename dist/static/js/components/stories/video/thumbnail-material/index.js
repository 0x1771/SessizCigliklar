...
const ThumbnailMaterial = React.forwardRef((props, ref) => {
    ...
    return (() => {
        return shaderMaterial ? ( <
            ...
            uniforms - uRolloverStrength - value = {
                rollover.rolloverStrength
            }
            uniforms - uWhiteOverlay - value = {
