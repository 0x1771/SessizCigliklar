...
export const def = {
  ...
  withDefault: <T>(value: T | undefined, defaultIfUndefined: T): T =>
    value !== void 0 ? value : defaultIfUndefined
}

export function matchKeysFromObject<T extends object, K extends object>(
  obj: T,
  matchingObject: K
): Partial<T> {
  const o: Partial<T> = {}
