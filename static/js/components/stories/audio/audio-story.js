...

        {
            isOnScreen ? ( <
                ...
                material = { <
                    AudioStoryMaterial
                    animate = {
                        isOnScreen && !props.isActive ? "in" : "out"
                    }
                    alphaTest = {
                        true
                    }
                ...
                fontSize = {
                    issues.REQUIRES_LOW_RES_TEXTURES ? 36 : 72
                }
                /> <
                /SceneOnMesh>
                ...
                animated.mesh visible = {
                    rollover.opacity.interpolate((v) => v > 0)
                }
                position = {
                    [0, 0, -0.01]
                } >
                <
                animated.meshBasicMaterial opacity = {
                    rollover.opacity
                }
                transparent = {
                    true
