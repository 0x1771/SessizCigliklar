...
const AudioStoryMaterial = (props) => {
    ...
    return ( <
        animated.primitive attach = "material"
        object = {
            shaderMaterial
        }
        uniforms - uTime - value = {
            clock.elapsedTime + timeOffset.current
        }
        uniforms - uDistortionStrength - value = {
            uniforms.distortion
        }
        uniforms - uPixelationStrength - value = {
            uniforms.pixelation
        }
        uniforms - uOpacityStrength - value = {
            opacity.opacity
        }
        uniforms - uInterlaceStrength - value = {
            interlace.interlace
        }
        />
    );
