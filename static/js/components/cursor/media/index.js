...
const MediaCursor = observer((props) => {
    ...
    return ( <
        ...
        <
        animated.circle className = "svg-circle-bg"
        cx = {
            center
        }
        cy = {
        ...
        /> <
        animated.circle className = "svg-circle-thin"
        cx = {
            center
        }
        cy = {
        ...
        strokeDashoffset = {
            bgThinAttr.percent.interpolate(
                (v) => innerCircumference * (1 - v)
            )
        }
        /> <
        circle className = "svg-circle-thick"
        cx = {
            center
        }
        cy = {
            ...
            (() => {
                ...
                switch (playStatus) {
                    ...
                    case "none":
                        return ( <
                            PlayIcon x = {
                                props.isMobile ? 30 : 40
                            }
                            y = {
                                props.isMobile ? 26 : 33
                            }
                            />
                        );
                }
