...
const AnimatedCursor = observer(() => {
            ...
            const [cursorText, setCursorText] = useState( < span > Keşfetmek İçin Kaydır. < /span>);
                ...
                return ( <
                    ...
                    style = {
                        {
                            transform: position.xy.interpolate(transformString)
                        }
                    } >
                    <
                    DragCursor animationDelay = {
                        animationDelay
                    }
                    animate = {
                        showDragCursor ? "in" : "out"
                    }
                    moveLeft = {
                        moveLeft
                    } >
                    ...
                    animate = {
                        showMediaCursor ? "in" : "out"
                    }
                    isMobile = {
                        issues.MOBILE
                    }
                    /> <
                    HomeCursor animationDelay = {
                        animationDelay
                    }
                    animate = {
                        showHomeCursor ? "in" : "out"
                    }
                    /> <
                    /CursorDiv>
                );
