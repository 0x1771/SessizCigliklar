            ...
            var e = Object(o.a)(a.a.mark((function e() {
                ...
                return a.a.wrap((function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return e.next = 2, t.e(5).then(t.bind(null, 11));
                        case 2:
                            if (n = e.sent, !n.check()) {
                                e.next = 11;
                                break
                            }
                            return e.next = 7, Promise.all([t.e(2), t.e(3)]).then(t.bind(null, 12));
                        case 7:
                            (n = e.sent).main(), e.next = 13;
                            break;
                        case 11:
                            document.getElementById("root").innerHTML = p.a.replace("%platform%", "".concat(c.a.name, " version ").concat(c.a.version));
                        case 13:
                        case "end":
                            return e.stop()
                    }
...
//# sourceMappingURL=main.8a95319a.chunk.js.map